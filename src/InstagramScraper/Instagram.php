...
///////////////////MODIFICADO///////////////
   ...
   */
  public function validateUrl(string $raw_url): string {
...
//        return md5(implode(':', [$this->getRhxGis(), $variables]));
    ...
    {
        $mediaUrl = $this->validateUrl($mediaUrl);
        ...
        if (static::HTTP_NOT_FOUND === $response->code) {
            throw new InstagramNotFoundException('1');
        }
